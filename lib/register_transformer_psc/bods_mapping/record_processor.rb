  ...
  module BodsMapping
    class RecordProcessor
      ...
      def process_many(psc_records)
        child_entities = psc_records.map { |psc_record| ["#{psc_record.data.etag}-child", map_child_entity(psc_record)] }.to_h
        parent_entities = psc_records.map { |psc_record| ["#{psc_record.data.etag}-parent", map_parent_entity(psc_record)] }.to_h
